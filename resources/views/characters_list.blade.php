...
@section('content')
    ...
    <div id='table-container'>
        @if (session()->exists('added'))
            <span class="status">{{ session('name') }} a été ajouté avec succès</span>
            <br>
        @endif
        ...
        <table>
            ...
            @foreach ($characters as $character)
                <tr>
                    ...
                    <td>{{ $character->bd }}</td>
                    <td class='drawer-td' 
                        data-birth="{{ $character->drawer->birth_year }}" 
                        data-nationality="{{ $character->drawer->nationality }}"
                        data-id="{{ $character->drawer->id }}"
                    >
                        {{ $character->drawer->name }}
                    </td>
                    <td>
                    ...
                    <td>
                        <form action="/characters/update_form" method="post">
                            @csrf
                            <input type="hidden" name="character_id" value="{{ $character->id }}">
        ...
        <a href="/characters/add_form" id="add-button">Ajouter un personnage</a>
    </div>
